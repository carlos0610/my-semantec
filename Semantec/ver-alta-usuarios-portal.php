  ...
  <div id="main">
   ...
   <div id="contenedor" style="height:auto;">
      ...
      <table class="forms" cellpadding="5">
          ...
          <tr>
            <td>&nbsp;</td>
            <td><a href="form-edit-usuarios-portal.php?usu_id=<?php echo($usu_id)?>">
              </a><a href="lista-usuarios-portal.php">
              <input type="button" value="Ir al Listado" class="botones" />
              </a><a href="form-edit-usuarios-portal.php?usu_id=<?php echo($usu_id)?>">
              <input type="button" value="Modificar datos" class="botones" /> 
              </a><a href="form-alta-usuarios-portal.php">
