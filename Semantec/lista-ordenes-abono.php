    ...
    $titulo = "Listado de Ordenes de Servicio.";
        ...
        $resultado = null;
           if(isset($filtrar)) {
                    ...
                    $sqlaux.=" AND ord_alta BETWEEN '$fecha_ini' AND '$fecha_fin' ";
...
{    
	document.getElementById("filtro").action="lista-ordenes-abono.php?pagina="+pagina;
  ...
  <div id="main">
   ...
   <div id="contenedor" style="height:auto;">
      ...
      <div id="buscador" >     
    <form id="filtro" name="filtro" action="lista-ordenes-abono.php<?php /*echo $PHP_SELF; */?>" method="POST">
