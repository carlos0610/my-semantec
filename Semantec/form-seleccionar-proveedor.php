...
?>    
  ...
  <div id="main">
   ...
   <div id="contenedor" style="height:auto;">
      ...
      <form name="frmSeleccionarProveedor" action="<?php if ($action == 1) echo "ver-corriente-proveedor.php?action=1"; else echo "form-alta-compra.php?ocultar=si";?>" method="post" ><table class="listados" cellpadding="5">
          <tr class="titulo">
