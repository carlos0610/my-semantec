<?php
    ...
    $titulo = "Formulario de alta de una Orden de Servicio.";
        ...
        $sql = "SELECT  cli_id, cli_nombre FROM clientes WHERE cli_id=2"; // aca cambiar la magia
    ...
    ?>
          ...
          <tr>
            ...
            <td>
                ...
                <input type="submit" value="Agregar Requerimiento" class="botones" />
            </td>
            <td></td>
          </tr>
          <tr>
