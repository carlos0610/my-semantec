<?php
    ...
    $tamPag=10;
        ...
        $sql = "SELECT distinct f.fco_id,f.fco_fecha ,c.cli_nombre,f.files_id,f.fco_subtotal, f.fco_nota  
                FROM factura_compra f,ordenes o,clientes c, detalle_factura_compra df
                WHERE  f.estado = 1
