...
if(validaSelect($selectDestino) && validaOpcion($opcionSeleccionada))
{
	...
	//conectar();
	$consulta=mysql_query("SELECT cli_id, cli_nombre,sucursal FROM $tabla WHERE $relacion='$opcionSeleccionada' AND estado = 1 order by cli_nombre,sucursal") or die(mysql_error());
	//desconectar();
